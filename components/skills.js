...
const SkillsSection =()=>{
    const [data, setData] = useState(
        [
            { value: 1, progress: '100%', name: 'HTML ' },
            { value: 1, progress: '100%', name: 'CSS    ' },
            { value: 0.9, progress: '90%', name: 'JS         ' },
            { value: 0.9, progress: '90%', name: 'Angular' },
            { value: 0.5, progress: '50%', name: 'React   ' },
        ])
    return(
      <>
      <LineSection/>
      <view style={style.body}>
        <Text style={{fontSize:40,fontWeight:'bold',color:'white'}}>skills:</Text>
        <br/><br/>
        {
        data.map((item)=>{
